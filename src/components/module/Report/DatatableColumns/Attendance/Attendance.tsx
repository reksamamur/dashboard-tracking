...
import { SchoolGateAttendance } from '@/model';
...
export const columns: ColumnDef<SchoolGateAttendance>[] = [
  {
    id: 'no',
    header: () => <span>No</span>,
  ...
  },
  {
    ...
    columns: [
      ...
      {
        accessorKey: 'gateInName',
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='Gate in Name' />
        ),
        cell: ({ row }) => {
          return (
            <span className='font-medium capitalize w-full'>
              {row.getValue('gateInName')}
            </span>
          );
        },
      },
...

  {
    ...
    columns: [
      ...
      {
        accessorKey: 'gateOutName',
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='Gate out Name' />
        ),
        cell: ({ row }) => {
          return (
            <span className='font-medium capitalize w-full'>
              {row.getValue('gateOutName')}
            </span>
          );
        },
      },
